...
| `variant` | string | - | Model reasoning effort: `minimal`, `high`, `max` |
...
You can control the reasoning effort for supported models (like Gemini 2.5) using the `variant` option:

| Variant | Description |
|---------|-------------|
| `minimal` | Fastest response, lower reasoning effort |
| `high` | Increased reasoning effort for complex tasks |
